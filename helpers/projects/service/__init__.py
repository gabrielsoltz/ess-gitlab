...
class GitlabProjectService:
    ...
    def get_project_info(self):
        ...
        if self.project_attributes is not None:
            project_info.update(
                {
                    "name": self.project_attributes["name"],
                    "name_with_namespace": self.project_attributes[
                        "name_with_namespace"
                    ],
                    "description": self.project_attributes["description"],
                    "web_url": self.project_attributes["web_url"],
                }
            )
    ...
    def get_project_labels(self):
        ...
        try:
            ...
            self.logging.error(
                "Error getting project {} labels: {}".format(self.project_id, e)
            )
    ...
    def get_project_topics(self):
        ...
        try:
            ...
            self.logging.error(
                "Error getting project {} topics: {}".format(self.project_id, e)
            )
        except exceptions.GitlabAuthenticationError as e:
            self.logging.error(
                "Error getting project {} topics: {}".format(self.project_id, e)
    ...
    def get_project_archived(self):
        try:
            ...
            self.logging.error(
                "Error getting project {} archived: {}".format(self.project_id, e)
            )
            archived = None
        except exceptions.GitlabAuthenticationError as e:
            self.logging.error(
    ...
    def get_project_attributes(self):
        try:
            ...
            self.logging.error(
                "Error getting project {} attributes: {}".format(self.project_id, e)
            )
    ...
    def get_project_languages(self):
        try:
            ...
            self.logging.error(
                "Error getting project {} languages: {}".format(self.project_id, e)
            )
    ...
    def get_project_contributors(self):
        try:
            ...
            self.logging.error(
                "Error getting project {} contributors: {}".format(self.project_id, e)
            )
    ...
    def get_project_push_rules(self):
        try:
            ...
            self.logging.error(
                "Error getting project {} push rules: {}".format(self.project_id, e)
            )
            push_rules = None
        except exceptions.GitlabAuthenticationError as e:
            self.logging.error(
    ...
    def get_protectedbranches(self):
        try:
            ...
            self.logging.error(
                "Error getting project {} protected branches: {}".format(
                    self.project_id, e
                )
            )
    ...
    def get_project_access_tokens(self):
        try:
            ...
            self.logging.error(
                "Error getting project {} access tokens: {}".format(self.project_id, e)
            )
            access_tokens = None
        except exceptions.GitlabAuthenticationError as e:
            self.logging.error(
    ...
    def get_project_deploy_tokens(self):
        try:
            ...
            self.logging.error(
                "Error getting project {} deploy tokens: {}".format(self.project_id, e)
            )
            deploy_tokens = None
        except exceptions.GitlabAuthenticationError as e:
            self.logging.error(
    ...
    def get_project_deploy_keys(self):
        try:
            ...
            self.logging.error(
                "Error getting project {} deploy keys: {}".format(self.project_id, e)
            )
            deploy_keys = None
        except exceptions.GitlabAuthenticationError as e:
            self.logging.error(
    ...
    def get_project_file(self, file, project=None, ref=None):
        ...
        try:
            ...
            if "404" in str(e):
                ...
                self.logging.error(
                    "Error getting project {} file: {} {}".format(
                        self.project_id, file, e
                    )
                )
                project_file = None
            ...
            self.logging.error(
                "Error getting project {} file: {} {}".format(self.project_id, file, e)
            )
            project_file = None
        except exceptions.GitlabListError as e:
            self.logging.error(
    ...
    def get_merged_pipeline(self):
        try:
            response = self.gitlab_connection.http_get(
            ...
            try:
                ...
                self.logging.error(
                    "Error getting project {} merged pipeline: {} - {}".format(
                        self.project_id, e, errors
                    )
                )
                pipeline = False
    ...
    def get_project_merged_pipeline_block(self, pipeline_yaml, block):
        if self.project_merged_pipeline:
            try:
                ...
                self.logging.error(
                    "Error getting project {} pipeline block: {}".format(
                        self.project_id, block
                    )
                )
                pipeline_block = None
        else:
    ...
    def get_project_runners(self):
        try:
            ...
            self.logging.error(
                "Error getting project {} runners: {}".format(self.project_id, e)
            )
            runners = None
        except exceptions.GitlabAuthenticationError as e:
            self.logging.error(
    ...
    def search_project(self, string_to_search):
        try:
            ...
            self.logging.error(
                "Error searching project {}: {}".format(self.project_id, e)
            )
            project_search = None
        except exceptions.GitlabAuthenticationError as e:
            self.logging.error(
